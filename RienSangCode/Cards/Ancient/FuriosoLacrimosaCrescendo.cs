...
public class FuriosoLacrimosaCrescendo : RienSangCard
{
    public FuriosoLacrimosaCrescendo() : base(3, CardType.Attack, CardRarity.Ancient, TargetType.RandomEnemy)
    {
    }
