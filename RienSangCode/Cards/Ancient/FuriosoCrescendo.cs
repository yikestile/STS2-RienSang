...
public class FuriosoCrescendo : RienSangCard
{
    public FuriosoCrescendo() : base(3, CardType.Attack, CardRarity.Ancient, TargetType.RandomEnemy)
    {
    }
    ...
    [
        ...
        new RepeatVar(9),
        new PowerVar<LCPoisePower>(6), 
        new("PoisePotency", 6),      
        new PowerVar<Mang>(2),
        new("SinkingPotency", 2)
    ];
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        {
            SanityManager.SpendSanity(Owner, 20f);
        ...
        var initialPoisePotency = player.HasPower<IndulgenceInPrescript>() ? 7 : DynamicVars["PoisePotency"].IntValue;
