...
public class StabTheHeartOfSilencePenetrateTheMemory : RienSangCard
{
    public StabTheHeartOfSilencePenetrateTheMemory() : base(2, CardType.Attack, CardRarity.Uncommon, TargetType.AnyEnemy)
    {
    }
    ...
    protected override IEnumerable<DynamicVar> CanonicalVars => [
        ...
        new RepeatVar(2),
        new PowerVar<LCWeakNextTurn>("WeakNextTurn", 1m) 
    ];
