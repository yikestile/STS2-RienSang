...
public class SwingToFellHaveItMeetTheGround : RienSangCard
{
    public SwingToFellHaveItMeetTheGround() : base(1, CardType.Attack, CardRarity.Common, TargetType.AnyEnemy)
    {
    }
