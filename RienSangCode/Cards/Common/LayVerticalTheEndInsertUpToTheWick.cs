...
public class LayVerticalTheEndInsertUpToTheWick : RienSangCard
{
    public LayVerticalTheEndInsertUpToTheWick() : base(0, CardType.Attack, CardRarity.Common, TargetType.AnyEnemy)
    {
    }
