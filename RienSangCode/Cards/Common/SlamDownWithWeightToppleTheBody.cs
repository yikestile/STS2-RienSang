...
public class SlamDownWithWeightToppleTheBody : RienSangCard
{
    public SlamDownWithWeightToppleTheBody() : base(0, CardType.Attack, CardRarity.Common, TargetType.AnyEnemy)
    {
    }
