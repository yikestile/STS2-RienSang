...
public class CarveAtALowSlantPeelWhatRemains : RienSangCard
{
    public CarveAtALowSlantPeelWhatRemains() : base(1, CardType.Attack, CardRarity.Common, TargetType.AnyEnemy)
    {
    }
